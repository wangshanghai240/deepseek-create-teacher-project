  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      if (!article.value?.content) {
        ...
        try {
          let apiUrl = '/api/renmin/detail?'
          if (article.value?.url) apiUrl += 'url=' + encodeURIComponent(article.value.url) + '&'
          if (article.value?.title) apiUrl += 'title=' + encodeURIComponent(article.value.title)
